...
const Home = () => {
  return (
    <body className='home text-white conatiner'>
      <div className='data conatiner w-75 mx-auto mt-5'>
      ...
      <div className=' buttons  '>
        ...
        <Link className='cv btn btn-outline-warning btn-sm' to="https://aadesh-sonawane.tiiny.site/"><i class="bi bi-arrow-down-circle-fill"></i> Download CV</Link>
